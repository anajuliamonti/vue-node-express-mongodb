...
var rotas = {
    ...
    autenticacao: require('./routes/auth/auth.js'), // http://localhost:3333/auth/v1/...
    //pessoa: require('./routes/pessoa'), // http://localhost:3333/pessoa/v1/...
    paciente: require('./routes/paciente/paciente.js'), // http://localhost:3333/paciente/v1/...
    psicologo: require('./routes/psicologo/psicologo.js'), // http://localhost:3333/psicologo/v1/...
    registros: require('./routes/registros/registros.js') // http://localhost:3333/registros/v1/...
};
...
app.use('/api/v1', apiRouter); //Rotas da api, protegidas, executam a função 'verifyJWT' para validar o token enviado na request
...
apiRouter.use('/paciente', rotas.paciente); //Todas as rotas configuradas em ./routes/paciente/index.js serão acessadas por http://localhost:3333/api/v1/paciente/...
apiRouter.use('/psicologo', rotas.psicologo); //Todas as rotas configuradas em ./routes/psicologo/index.js serão acessadas por http://localhost:3333/api/v1/psicologo/...
apiRouter.use('/registros', rotas.registros); //Todas as rotas configuradas em ./routes/registros/index.js serão acessadas por http://localhost:3333/api/v1/registros/...
