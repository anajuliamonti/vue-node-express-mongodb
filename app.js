...
var rotas = {
    ...
    autenticacao: require('./routes/auth/auth'), // http://localhost:3333/auth/v1/...
    //pessoa: require('./routes/pessoa'), // http://localhost:3333/pessoa/v1/...
    paciente: require('./routes/paciente/paciente'), // http://localhost:3333/paciente/v1/...
    psicologo: require('./routes/psicologo/psicologo'), // http://localhost:3333/psicologo/v1/...
    registros: require('./routes/registros/registros') // http://localhost:3333/registros/v1/...
};
